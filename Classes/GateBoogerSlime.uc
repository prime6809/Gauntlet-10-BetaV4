...
// GateBoogerSlime.
//=============================================================================
class GateBoogerSlime expands BoogerSlime config(GauntletScoreing);
...
// A simple fix so the booger will stop trying to use an animation only a pupae has [rools eyes]
// AND MORE IMPORTANTLY SO THEY WON'T SPAM THE ERROR LOG!!
...
{
      Value=8
      RangedProjectile=Class'Botpack.UT_BioGel'
      ReducedDamageType="slimed"
      ReducedDamagePct=1.000000
      MenuName="Slime Booger"
      NameArticle="a "
      Texture=WetTexture'Gauntlet-10-BetaV4.Skin.SlimeboogerSkin'
      ScaleGlow=2.000000
      AmbientGlow=255
      bUnlit=True
}
