...
// ZapSeekS.
//=============================================================================
class ZapSeekS extends ZapSeek;
...
simulated function Tick(float DeltaTime)
{
	...
	if ( Instigator != None )
	{
		if ( (Level.NetMode == NM_Client) && (!Instigator.IsA('PlayerPawn') || (PlayerPawn(Instigator).Player == None)) )
		{
			...
			//DrawOffset = ((0.01 * class'Zapper2'.Default.PlayerViewOffset) >> Rotation);
...
X.X+=(spread*(0.5-frand()));
X.Y+=(spread*(0.5-frand()));
X.Z+=(spread*(0.5-frand()));
X=Normal(X);
SetRotation(Rotator(X));

bUpdated = true; //always true for startsegment
...
defaultproperties
{
      ...
      AnimTime=0.000000
      SpriteAnim(0)=Texture'Gauntlet-10-BetaV4.Skins.bluesbolt0'
      SpriteAnim(1)=Texture'Gauntlet-10-BetaV4.Skins.bluesbolt1'
      SpriteAnim(2)=Texture'Gauntlet-10-BetaV4.Skins.bluesbolt2'
      SpriteAnim(3)=Texture'Gauntlet-10-BetaV4.Skins.bluesbolt3'
      SpriteAnim(4)=Texture'Gauntlet-10-BetaV4.Skins.bluesbolt4'
      RemoteRole=ROLE_SimulatedProxy
      LifeSpan=1.200000
      Texture=Texture'Gauntlet-10-BetaV4.Skins.bluesbolt0'
      Skin=Texture'Gauntlet-10-BetaV4.Skins.bluesbolt0'
      LightType=LT_Steady
